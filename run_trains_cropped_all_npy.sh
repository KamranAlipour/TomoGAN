python3 main-gan.py -gpu 0 -resfolder train_shuffle_cropped_mse50_100k_results -expName test -ite 100001 -xtrain dataset/cropped/npy_frames_split_1024_train/input_* \
